        ...
        <div className="col-4 pb-3">
            <div className={`card  `}>
                ...
                <div className="card-body p-0">
                    <p className="fw-bold">{restur.name}</p>
                    <div className="d-flex">
                        {restur.food_types.slice(0, 3).map((type, index) => (
                    ...
                    <div className="d-flex justify-content-between">
                        {restur.ratings !== "" ? (
                            <p className="bg-success rounded" style={{ padding: "0px 4px" }}>
                                ★{restur.ratings}
                            </p>
                        ) : (
                        ...
                        <p>•</p>
                        {restur.delivery_time !== "" ? (
                            <p>{restur.delivery_time}</p>
                        ) : (
                            <p>--</p>
                        )}
                        <p>•</p>
                        {restur.price_for_two !== "" ? (
                            <p>₹{restur.price_for_two} FOR TWO</p>
                        ) : (
                            <p>--</p>
                        )}
                    </div>
